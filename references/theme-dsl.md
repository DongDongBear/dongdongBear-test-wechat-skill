...
但选色不是选一个"好看的颜色"，是选一种**情绪光线**：

| 色彩 | 情绪 | 适合内容 |
|------|------|---------|
| #3498db 经典蓝 | 信任、专业、中性 | 通用内容 |
| #5a6374 石板灰 | 肃穆、沉思、距离 | 悼念、严肃话题 |
| #8b6f47 赭石棕 | 温暖、叙事、人文 | 故事、散文 |
| #2c5f2d 深森绿 | 沉稳、自然、成长 | 教育、健康 |
| #6b4c9a 暗紫 | 神秘、创意、深邃 | 文化、艺术 |
| #c0392b 沉红 | 警醒、力量、紧迫 | 评论、观点文 |
| #1a1a2e 墨夜蓝 | 深邃、科技、前沿 | 科技、AI |
| #d4a373 琥珀暖金 | 怀旧、温情、秋日 | 回忆、人物 |

**三色规则：** 主题色（标题、装饰）+ 正文色（#2c2c2c ~ #3f3f3f）+ 辅助色（引用、注释用的灰）。不要更多。
